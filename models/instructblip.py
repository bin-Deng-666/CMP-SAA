...
class EvalModel(BaseEvalModel):
    """My customized InstructBLIP model implementation."""
    ...
    def __init__(self, model_args):
        ...
        self.model = InstructBlipForConditionalGeneration.from_pretrained(model_args["lm_path"])
    ...
    def get_caption_prompt(self, caption: str = None) -> str:
        return ""  # InstructBLIP不需要特殊caption提示

    def get_classification_prompt(self, class_str: str = None) -> str:
        return ""  # InstructBLIP不需要特殊分类提示
